...
#
#
# def stitch_belt_to_point(point, belt, bottom=False):
#
#     faces = np.array([
#         [belt[0], belt[1], point],
#         [belt[1], belt[2], point],
...
#
#
# def seal_belt(belt, bottom=False):
#     faces = np.array([
...
#         meshes = []
#
#         grid = functools.reduce(OctoGrid.__add__, grids)
#
#         mesh_data = [self.octo_mesh(cell, config).data for cell in grid.occ.values]
#
#
#
...
#
#     def octo_mesh(self, cell, config):
#         return neo_trimmed_octo
#
