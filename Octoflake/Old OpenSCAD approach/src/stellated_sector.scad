            ...
            translate(undersize/4 * [0, 0, 0]) welding_cube();
            translate(undersize/4 * [2, 2, 0]) welding_cube();
            translate(undersize/4 * [4, 4, 0]) welding_cube();


            translate(undersize/4 * [1, 1, 0]) rotate(R0) trim_front() sector();
            translate(undersize/4 * [1, 1, 0]) rotate(R270) trim_front() sector();
mirror(Y)   translate(undersize/4 * [1, 1, 0]) rotate(R0)  trim_front() sector();
mirror(Y)   translate(undersize/4 * [1, 1, 0]) rotate(R270) trim_front() sector();


            translate(undersize/4 * [3, 1, 0]) rotate(R0) trim_left() kern_right() sector();
            translate(undersize/4 * [3, 1, 0]) rotate(R90)  trim_front() sector();
            translate(undersize/4 * [3, 1, 0]) rotate(R180)  trim_front() sector();
            translate(undersize/4 * [3, 1, 0]) rotate(R270)trim_front() sector();
            
mirror(Y)   translate(undersize/4 * [3, 1, 0]) rotate(R0) trim_left() kern_right() sector();
mirror(Y)   translate(undersize/4 * [3, 1, 0]) rotate(R90) trim_front()sector();
mirror(Y)   translate(undersize/4 * [3, 1, 0]) rotate(R180) trim_front()sector();
mirror(Y)   translate(undersize/4 * [3, 1, 0]) rotate(R270) trim_front()sector();


            translate(undersize/4 * [5, 3, 0]) rotate(R0) trim_right() sector();
            translate(undersize/4 * [5, 3, 0]) rotate(R90)  trim_front() sector();
            translate(undersize/4 * [5, 3, 0]) rotate(R180)  trim_front() sector();
            translate(undersize/4 * [5, 3, 0]) rotate(R270) kern_left() sector();
            
mirror(Y)   translate(undersize/4 * [5, 3, 0]) rotate(R0)   trim_right() sector();
mirror(Y)   translate(undersize/4 * [5, 3, 0]) rotate(R90) trim_front() sector();
mirror(Y)   translate(undersize/4 * [5, 3, 0]) rotate(R180) trim_front() sector();
mirror(Y)   translate(undersize/4 * [5, 3, 0]) rotate(R270) kern_left() sector();


            translate(undersize/4 * [3, 3, 0]) rotate(R0)  trim_front() sector();
            translate(undersize/4 * [3, 3, 0]) rotate(R270) trim_front() sector();
mirror(Y)   translate(undersize/4 * [3, 3, 0]) rotate(R0)   trim_front() sector();
mirror(Y)   translate(undersize/4 * [3, 3, 0]) rotate(R270) trim_front() sector();

            translate(undersize/4 * [5, 5, 0]) rotate(R0)  trim_left() sector();
            translate(undersize/4 * [5, 5, 0]) rotate(R270) trim_front() sector();
mirror(Y)   translate(undersize/4 * [5, 5, 0]) rotate(R0)  trim_left() sector();
mirror(Y)   translate(undersize/4 * [5, 5, 0]) rotate(R270) trim_front() sector();
